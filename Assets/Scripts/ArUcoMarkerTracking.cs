// ArUcoMarkerTracking - integrates with OpenCV to track position and orientation 
// of ArUco markers, used to detect where physical cubes are
// 
// Code originally forked from repo by Takashi Yoshinaga: 
